                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('update.slide') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input name="video_url" value="{{ $homeslide->video_url }}" class="form-control" type="text" id="video_url">
                            </div>
                        </div>
                        <!-- end row -->
                        ...
                        <div class="row mb-3">
                            ...
                            (!empty($homeslide->home_slide))? url('upload/home_slide/'.$homeslide->home_slide): url('upload/no-image.jpg') }}" alt="image">
                            </div>
                        </div>
                        <!-- end row -->

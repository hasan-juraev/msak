...
<!-- breadcrumb-area-end -->
            ...
            <section class="standard__blog">
                ...
                <div class="container">
                    ...
                    <div class="row"> 
                          <!-- col-lg-4 should be on the right side, after col-lg-8 -->
                         <div class="col-lg-4">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="standard__blog__post">
                                <div class="standard__blog__thumb">
                                    <a href="{{ route('blog.detail', $item->id) }}"><img src="{{ asset($item->blog_image) }}" alt=""></a>
                                ...
                                <div class="standard__blog__content">
                                    ...
                                    <h2 class="title"><a href="{{ route('blog.detail',  $item->id) }}"> {{ $item->blog_title }} </a></h2>
                                    <p> {!! Str::limit($item->blog_description, 250) !!} </p>                                    
                                    
                                    <ul class="mb-3 blog__post__meta">
